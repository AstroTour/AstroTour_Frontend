...
const SolarSystemDesktop = ({ planets }) => {
  const getPlanetInfo = (planetName: string) => {
    const planet = planets.find(
      (p: any) => p.name.toLowerCase() === planetName.toLowerCase()
    );
    return planet ? planet.information : '';
  };

  return (
    <div className="main-wrapper hidden lg:block">
...
export default SolarSystemDesktop;
